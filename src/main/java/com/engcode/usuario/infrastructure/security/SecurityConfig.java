    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui.html").permitAll() // Permite acesso ao endpoint do swagger.
                        ...
                        .requestMatchers(HttpMethod.GET, "/usuario/endereco/**").permitAll() // Permite acesso ao endpoint de cep
